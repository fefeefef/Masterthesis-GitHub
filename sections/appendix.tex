...
\begin{table}[t]
\centering
\caption{Per-country breakdown. Gate rate is the share of
...
\begin{table}[t]
\centering
\caption{Tail asymmetry (share of lower violations among
...
\begin{table}[t]
\centering
\caption{Mean coverage (\%) by calibration-pool window.
...
\begin{table}[t]
\centering
\caption{Left: seed dispersion of the neural families.
