...
\begin{enumerate}
  ...
  \item In rare cases the calibrated interval inverts (lower bound above upper bound). We repair this by swapping the edges and log the event with \texttt{crossed\_cal} flag.
%------------------------------------------------------------------------
