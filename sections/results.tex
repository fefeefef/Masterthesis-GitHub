...
\caption{% TODO Caption. Best admissible package per model family, ranked
         by median Winkler skill against RW/L/native.}
...
%========================================================================
%  ANSCHLUSS-KAPITEL, DIE AUF DIESEM AUFBAUEN (noch nicht angelegt)
%------------------------------------------------------------------------
%  Discussion/Limitations -- die Punkte, die hier aufgeworfen wurden:
%    * Kontaminationsverdacht TiRex-2 (Release 2026-07-01, Cutoff
%      undokumentiert, Testfenster bis 2026-04). Das entwertet Befund (3)
%      potenziell vollstaendig und MUSS prominent stehen, nicht in einer
%      Fussnote.
%    * DQ-Ablehnung in 49.3% der Zellen -> bedingte Kalibrierung ist auch
%      im validen Bereich verletzt.
%    * Fehlende statistische Signifikanz aller Cross-Model-Kontraste.
%    * Seed-Fragilitaet der NN-Ergebnisse (52%).
%    * Ex-IE-Niveaueffekt und die irische IP-Verzerrung.
%    * GR: PSI-Strukturbruch 2012, Gate-Rate nur 0.519.
%    * Burn-in-Doppelrolle des Validierungsfensters.
%    * Stichprobe: 277 Monate insgesamt, 127 im Test -- die Obergrenze
%      fuer alles, was hier gemessen werden kann.
